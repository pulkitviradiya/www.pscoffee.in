...
- `Logo Files/` (root) is an untracked raw logo-source drop, kept out of git deliberately per an
  earlier explicit user decision — not a bug, just flagging so it isn't accidentally force-added.
